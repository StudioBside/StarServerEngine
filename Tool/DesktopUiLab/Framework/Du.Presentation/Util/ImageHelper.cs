...
public static class ImageHelper
{
    ...
    public static readonly string NoImage = Path.GetFullPath("./Assets/Images/noimage.png");
    ...
    public static void CreateThumbnail(string filePath, int thumbnailWidth)
    {
        ...
        // 원본 이미지가 만들려는 썸네일보다 작으면 원본 이미지를 그대로 복사
        if (bitmap.PixelWidth <= thumbnailWidth)
        {
